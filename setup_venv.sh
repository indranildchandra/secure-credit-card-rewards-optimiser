...
echo "   Test:      source .adk_env/bin/activate && python -m pytest tests/ -q"
echo ""
echo "   NOTE: activate the venv first (source .adk_env/bin/activate) — otherwise"
echo "         'python' is your system Python and won't have pytest/deps installed."
